...
/**
 * @author zhangmingyue01
 * @version V1.0
 * @since 2021/03/19
 */
class VulkanCameraSampleActivity extends Activity implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, FilterHelper.OnFilterSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sourceCamera = new GPUImageSourceCamera(VulkanCameraSampleActivity.this);
                        ...
                        if (result != null) {
                            ...
                            try {
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(VulkanCameraSampleActivity.this, "Image Saved:" + file.getAbsolutePath(), Toast.LENGTH_SHORT).show();
                                    }
                                });

                                // Tell the media scanner about the new file,
                                // so that it is immediately present in your album.
                                MediaScannerConnection.scanFile(VulkanCameraSampleActivity.this,
                                        new String[] {
                                                file.toString()
                                        }, null, null);
